...
classes = open('/home/lionel/Desktop/Biscuit_Stable_BoundingBox/yolo-coco/coco.names').read().strip().split('\n')
np.random.seed(42)
colors = np.random.randint(0, 255, size=(len(classes), 3), dtype='uint8')

# Give the configuration and weight files for the model and load the network.
net = cv.dnn.readNetFromDarknet('/home/lionel/Desktop/Biscuit_Stable_BoundingBox/yolo-coco/yolov3.cfg',
 '/home/lionel/Desktop/Biscuit_Stable_BoundingBox/yolo-coco/yolov3.weights')
